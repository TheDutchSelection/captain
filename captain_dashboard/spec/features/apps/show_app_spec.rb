...
RSpec.describe 'show app', type: :feature do
  ...
  describe 'clicking the zone buttons' do
    ...
    it 'should set the update key in redis to 1 when clicked' do
      visit apps_path
      click_link('Price Comparator')
      click_link('Update')

      update_value_1 = redis_storage_service.hget('vla1:containers:price_comparator_nl_telecom_portal:vla1wrkprd001', 'update')
      update_value_2 = redis_storage_service.hget('vla1:containers:price_comparator_nl_telecom_backend:vla1wrkprd002', 'update')
      update_value_3 = redis_storage_service.hget('vla1:containers:nginx_price_comparator_nl_telecom_portal:vla1wrkprd003', 'update')
      update_value_4 = redis_storage_service.hget('vla1:containers:redis_master:vla1wrkprd004', 'update')
    ...
    it 'should set the restart key in redis to 1 when clicked' do
      visit apps_path
      click_link('Price Comparator')
      click_link('Restart')
